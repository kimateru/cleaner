...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-sm",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "text-foreground border-2 hover:bg-muted/50 hover:shadow-md backdrop-blur-sm",
      },
    },
    defaultVariants: {
      variant: "default",
